...
const Home = () => {
  return (
    <>
      <Dialog open={true} title={"Create User"}>
      ...
      >
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary" gutterBottom>
            ...
            elit volutpat sagittis. Etiam egestas nulla tortor, sed pulvinar
            ante sollicitudin non. Phasellus lacinia fermentum dui non interdum.
            Nam condimentum, tortor ornare cursus dictum, massa sem gravida
            purus, non congue massa augue et massa. Sed erat ex, malesuada vel
            mi id, ultrices malesuada dui. Maecenas gravida, arcu a posuere
            auctor, elit ipsum dapibus massa, ac viverra magna orci id erat.
          </Typography>
